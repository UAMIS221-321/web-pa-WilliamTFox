...
function handleEditClick()
{
    ...
    document.getElementById("saveButton").style.display = "inline-blcok";
}
...
{
    document.getElementById("newButton").style.display = "inline-blcok";
    document.getElementById("editButton").style.display = "inline-blcok";
    document.getElementById("deleteButton").style.display = "inline-blcok";
    document.getElementById("rentButton").style.display = "inline-blcok";
    document.getElementById("returnButton").style.display = "inline-blcok";
